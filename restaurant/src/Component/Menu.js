  ...
  return (
    <div>
      ...
      <Card className="bg-dark text-white" style={{ borderRadius: "0px" }}>
        <Card.Img src={require("./img/bg-2.png")} style={{ height: "300px" }} />
        <Card.ImgOverlay className="text-center d-flex flex-column justify-content-center">
          <Card.Title className="fs-1">Our Menu</Card.Title>
          <Card.Text className="textc">Fresh & Delicious</Card.Text>
        </Card.ImgOverlay>
      </Card>
      ...
      <Container>
        <Row>
          <Col xs={12} md={12} className="text-center my-5">
            <h2>Mains</h2>
            <p className="textc">Fresh and delicious</p>
          </Col>
        </Row>
        <Row className="mb-5">
          <Col xs={12} md={12} lg={6}>
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  Crispy spring rolls filled with seasoned vegetables and served
                  with tangy sauce.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6}>
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  Delicate rice rolls stuffed with fresh shrimp, herbs, and
                  vermicelli.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6} className="my-3">
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  Creamy crab mixture baked in shells, topped with golden
                  cheese.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6} className="my-3">
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  Golden fried calamari served with garlic aioli — crispy and
                  flavorful.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6}>
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  Rich duck liver pâté served with toast and fig compote — a
                  French delicacy.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6}>
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  North Indian-style spiced vegetables cooked in traditional
                  curry flavors.
                </p>
              </Col>
            </Row>
            ...
            <Col xs={12} md={12} lg={6}>
              <Row>
                ...
                <Col md={9} xs={9}>
                  ...
                  <p className="c3 mt-1">
                    A spicy Indo-Chinese soup with crispy noodles, packed with
                    veggies and bold flavors.
                  </p>
                </Col>
              </Row>
            </Col>
            ...
            <Col xs={12} md={12} lg={6}>
              <Row>
                ...
                <Col md={9} xs={9}>
                  ...
                  <p className="c3 mt-1">
                    Fresh tomatoes, mozzarella, and basil drizzled with olive
                    oil — a light Italian classic.
                  </p>
                </Col>
              </Row>
            </Col>
            ...
            <Col xs={12} md={12} lg={6} className="my-3">
              <Row>
                ...
                <Col md={9} xs={9}>
                  ...
                  <p className="c3 mt-1">
                    Juicy Italian meatballs served in a rich tomato sauce —
            ...
            <Col xs={12} md={12} lg={6} className="my-3">
              <Row>
                ...
                <Col md={9} xs={9}>
                  ...
                  <p className="c3 mt-1">
                    Warm, golden waffles served with syrup and fruit — perfect
                    for a sweet starter.
                  </p>
                </Col>
              </Row>
            ...
            <Col xs={12} md={12} lg={6}>
              <Row className="mb-5">
                ...
                <Col md={9} xs={9}>
                  ...
                  <p className="c3 mt-1">
                    Goat cheese served over toast with herbs and a drizzle of
                    honey — creamy and tangy.
                  </p>
                </Col>
              </Row>
            </Col>
            <Col xs={12} md={12} lg={6}>
              <Row>
                ...
                <Col md={9} xs={9}>
                  ...
                  <div className="c2 fs-5">$10</div>
                  <p className="c3 mt-1">
                    Crispy fried calamari rings served with tangy dipping sauce
                    — a seafood favorite.
                  </p>
                </Col>
              </Row>
          ...
          <Col xs={12} md={12} lg={6}>
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  A refreshing blend of lime juice and mint, served chilled to
                  keep you cool. Perfect for a light, zesty sip any time of the
                  day.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6}>
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  Freshly brewed tea poured over ice with a hint of lemon—cool
                  and energizing.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6} className="my-3">
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <div className="c2 fs-5">$6</div>
                <p className="c3 mt-1">
                  A creamy milkshake with your choice of flavor — rich, thick,
                  and satisfying.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6} className="my-3">
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <div className="c2 fs-5">$3</div>
                <p className="c3 mt-1">
                  Freshly squeezed oranges packed with natural vitamin C and
                  citrus flavor.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6}>
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <div className="c2 fs-5">$5</div>
                <p className="c3 mt-1">
                  A soothing hot tea brewed to perfection — ideal for a relaxing
                  moment.
                </p>
              </Col>
            </Row>
          ...
          <Col xs={12} md={12} lg={6}>
            <Row>
              ...
              <Col md={9} xs={9}>
                ...
                <p className="c3 mt-1">
                  Bold and aromatic coffee made from fresh ground beans — a
                  daily delight.
                </p>
              </Col>
            </Row>
